...
void create_lowpass(double* filter, int rows, int cols, int scale)
{   
    /*
...
void create_highpass(double* filter, int rows, int cols, int scale)
{   
    /*
...
double* create_directional(double* filter, int rows, int cols, int Q, int q)
{
    /*
    Creates high pass filter specified in Heeger Bergen paper
